...
class AdminNotificationsManager extends Database {
    ...
    public function createDisapprovalNotification($id_number, $item_name, $quantity) {
        ...
        $message = "The $item_name you returned with the quantity of $quantity is disapproved. Please return the item/items or you can approach the MB laboratory incharge Sir/Maam: {$admin['first_name']} {$admin['last_name']}.";
